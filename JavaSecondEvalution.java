...
public class CollegeMngmntSys {
    public static void main(String[] args) {
        ...
        Student student1 = new Student(1, "Aakash", "aakash@gmail.com", "123-456-7890", "Shivane, Pune-23");
        Student student2 = new Student(2, "manas", "manas@example.com", "987-654-3210", "Rajgurunagar, Pune-23");
